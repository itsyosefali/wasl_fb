...
// Provider is a stub for future Telegram Bot API integration.
type Provider struct{}

func NewProvider() *Provider { return &Provider{} }

func (p *Provider) Channel() providers.Channel { return providers.ChannelTelegram }

func (p *Provider) notImplemented(action string) error {
	return fmt.Errorf("telegram provider: %s not implemented yet", action)
}
